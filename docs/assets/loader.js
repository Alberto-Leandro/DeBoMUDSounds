(() => {
  ...
  function createAudioContext() {
    const ContextClass = globalThis.window?.AudioContext || globalThis.window?.webkitAudioContext;
    if (!ContextClass) {
      return null;
    }
    try {
  ...
  var TriggerRuntime = class {
    constructor(config) {
      ...
      this.timer = null;
      this.pendingText = "";
      this.stateFlags = /* @__PURE__ */ new Map();
      this.stateTimers = /* @__PURE__ */ new Map();
    }
    start() {
